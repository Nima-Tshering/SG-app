...
public class SearchHomestay extends AppCompatActivity {
...
private RecyclerView search_list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_homestay);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Homestays>options=
                ...
                .setQuery(reference.orderByChild("destination").startAt(searchText).endAt(searchText),Homestays.class)
                .build();
                ...
                new FirebaseRecyclerAdapter<Homestays, HomestayViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull HomestayViewHolder holder, int position, @NonNull final Homestays model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent=new Intent(SearchHomestay.this,HomestayDetials.class);
