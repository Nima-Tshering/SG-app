...
public class CapitalHomestay extends AppCompatActivity {
private RecyclerView capitallist;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_capital_homestay);
        capitallist=findViewById(R.id.capitallist);
                    ...
                    protected void onBindViewHolder(@NonNull HomestayViewHolder holder, int position, @NonNull final Homestays model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(CapitalHomestay.this,HomestayDetials.class);
        ...
        capitallist.setAdapter(adapter);
