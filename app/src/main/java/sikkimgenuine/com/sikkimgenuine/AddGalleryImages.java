...
public class AddGalleryImages extends AppCompatActivity implements View.OnClickListener{
            ...
            sRef.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toasty.custom(getApplicationContext(), "File Uploaded Successfully", getResources().getDrawable(R.drawable.ic_check),
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toasty.custom(getApplicationContext(),e.getMessage(), getResources().getDrawable(R.drawable.ic_error_outline_white_24dp),
                            getColor(R.color.colorPrimaryDark), Color.WHITE, Toasty.LENGTH_SHORT, true, true).show();
