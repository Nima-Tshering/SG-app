...
public class CheapHomestay extends AppCompatActivity {
private RecyclerView cheap_list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cheap_homestay);
        cheap_list=findViewById(R.id.cheaplist);
        cheap_list.setLayoutManager(new LinearLayoutManager(this));
        ...
        FirebaseRecyclerOptions<Homestays> options=
                new FirebaseRecyclerOptions.Builder<Homestays>()
                        .setQuery(reference.orderByChild("type").startAt("cheap").endAt("cheap"),Homestays.class)
                        .build();
                    ...
                    protected void onBindViewHolder(@NonNull HomestayViewHolder holder, int position, @NonNull final Homestays model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent=new Intent(CheapHomestay.this,HomestayDetials.class);
